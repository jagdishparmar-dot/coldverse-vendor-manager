...
import { Archive, FileText, RefreshCw, Search, Users } from "lucide-react";
        ...
        <div className="flex items-center gap-3 mb-2">
          ...
          <div>
            ...
            <p className="text-xs text-gray-500">
              Track all deleted vendors and invoices. You can view their deletion remarks and restore
              them to active status at any time.
            </p>
          </div>
        </div>
      </div>
          ...
          <div className="bg-gray-50/80 px-5 py-4 border-b border-gray-100 flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <h3 className="text-xs font-bold uppercase tracking-wider text-gray-700">
                Archived Vendors ({archivedVendors.length})
              </h3>
            </div>
          </div>
